...
#include <stella_sim/msg/gimbal_angle_euler_cmd.hpp>
#include <stella_sim/msg/gimbal_angle_quat_cmd.hpp>
#include <stella_sim/msg/gps_yaw.hpp>
#include <stella_sim/srv/land.hpp>
#include <stella_sim/srv/land_group.hpp>
#include <stella_sim/srv/reset.hpp>
#include <stella_sim/srv/takeoff.hpp>
#include <stella_sim/srv/takeoff_group.hpp>
#include <stella_sim/msg/vel_cmd.hpp>
#include <stella_sim/msg/vel_cmd_group.hpp>
#include <stella_sim/msg/car_controls.hpp>
#include <stella_sim/msg/car_state.hpp>
#include <stella_sim/msg/environment.hpp>
#include <stella_sim/msg/altimeter.hpp> //hector_uav_msgs defunct?
#include <chrono>
...
private:
    ...
    public:
        ...
        rclcpp::Publisher<stella_sim::msg::Environment>::SharedPtr env_pub_;
        stella_sim::msg::Environment env_msg_;

        std::vector<SensorPublisher<stella_sim::msg::Altimeter>> barometer_pubs_;
    ...
    public:
        ...
        rclcpp::Subscription<stella_sim::msg::CarControls>::SharedPtr car_cmd_sub_;
        rclcpp::Publisher<stella_sim::msg::CarState>::SharedPtr car_state_pub_;
        stella_sim::msg::CarState car_state_msg_;
    ...
    public:
        ...
        rclcpp::Subscription<stella_sim::msg::VelCmd>::SharedPtr vel_cmd_body_frame_sub_;
        rclcpp::Subscription<stella_sim::msg::VelCmd>::SharedPtr vel_cmd_world_frame_sub_;

        rclcpp::Service<stella_sim::srv::Takeoff>::SharedPtr takeoff_srvr_;
        rclcpp::Service<stella_sim::srv::Land>::SharedPtr land_srvr_;
    ...
    void vel_cmd_world_frame_cb(const stella_sim::msg::VelCmd::SharedPtr msg, const std::string& vehicle_name);
    void vel_cmd_body_frame_cb(const stella_sim::msg::VelCmd::SharedPtr msg, const std::string& vehicle_name);

    void vel_cmd_group_body_frame_cb(const stella_sim::msg::VelCmdGroup::SharedPtr msg);
    void vel_cmd_group_world_frame_cb(const stella_sim::msg::VelCmdGroup::SharedPtr msg);

    void vel_cmd_all_world_frame_cb(const stella_sim::msg::VelCmd::SharedPtr msg);
    void vel_cmd_all_body_frame_cb(const stella_sim::msg::VelCmd::SharedPtr msg);

    // void vel_cmd_body_frame_cb(const stella_sim::msg::VelCmd& msg, const std::string& vehicle_name);
    void gimbal_angle_quat_cmd_cb(const stella_sim::msg::GimbalAngleQuatCmd::SharedPtr gimbal_angle_quat_cmd_msg);
    void gimbal_angle_euler_cmd_cb(const stella_sim::msg::GimbalAngleEulerCmd::SharedPtr gimbal_angle_euler_cmd_msg);

    // commands
    void car_cmd_cb(const stella_sim::msg::CarControls::SharedPtr msg, const std::string& vehicle_name);
    ...
    bool takeoff_srv_cb(const std::shared_ptr<stella_sim::srv::Takeoff::Request> request, const std::shared_ptr<stella_sim::srv::Takeoff::Response> response, const std::string& vehicle_name);
    bool takeoff_group_srv_cb(const std::shared_ptr<stella_sim::srv::TakeoffGroup::Request> request, const std::shared_ptr<stella_sim::srv::TakeoffGroup::Response> response);
    bool takeoff_all_srv_cb(const std::shared_ptr<stella_sim::srv::Takeoff::Request> request, const std::shared_ptr<stella_sim::srv::Takeoff::Response> response);
    bool land_srv_cb(const std::shared_ptr<stella_sim::srv::Land::Request> request, const std::shared_ptr<stella_sim::srv::Land::Response> response, const std::string& vehicle_name);
    bool land_group_srv_cb(const std::shared_ptr<stella_sim::srv::LandGroup::Request> request, const std::shared_ptr<stella_sim::srv::LandGroup::Response> response);
    bool land_all_srv_cb(const std::shared_ptr<stella_sim::srv::Land::Request> request, const std::shared_ptr<stella_sim::srv::Land::Response> response);
    bool reset_srv_cb(const std::shared_ptr<stella_sim::srv::Reset::Request> request, const std::shared_ptr<stella_sim::srv::Reset::Response> response);
    ...
    stella_sim::msg::CarState get_roscarstate_msg_from_car_state(const msr::airlib::CarApiBase::CarState& car_state) const;
    msr::airlib::Pose get_airlib_pose(const float& x, const float& y, const float& z, const msr::airlib::Quaternionr& airlib_quat) const;
    stella_sim::msg::GPSYaw get_gps_msg_from_airsim_geo_point(const msr::airlib::GeoPoint& geo_point) const;
    ...
    stella_sim::msg::Altimeter get_altimeter_msg_from_airsim(const msr::airlib::BarometerBase::Output& alt_data) const;
    ...
    stella_sim::msg::Environment get_environment_msg_from_airsim(const msr::airlib::Environment::State& env_data) const;
    msr::airlib::GeoPoint get_origin_geo_point() const;
    VelCmd get_airlib_world_vel_cmd(const stella_sim::msg::VelCmd& msg) const;
    VelCmd get_airlib_body_vel_cmd(const stella_sim::msg::VelCmd& msg, const msr::airlib::Quaternionr& airlib_quat) const;
...
private:
    ...
    rclcpp::Subscription<stella_sim::msg::VelCmd>::SharedPtr vel_cmd_all_body_frame_sub_;
    rclcpp::Subscription<stella_sim::msg::VelCmd>::SharedPtr vel_cmd_all_world_frame_sub_;
    rclcpp::Service<stella_sim::srv::Takeoff>::SharedPtr takeoff_all_srvr_;
    rclcpp::Service<stella_sim::srv::Land>::SharedPtr land_all_srvr_;
    ...
    rclcpp::Subscription<stella_sim::msg::VelCmdGroup>::SharedPtr vel_cmd_group_body_frame_sub_;
    rclcpp::Subscription<stella_sim::msg::VelCmdGroup>::SharedPtr vel_cmd_group_world_frame_sub_;
    rclcpp::Service<stella_sim::srv::TakeoffGroup>::SharedPtr takeoff_group_srvr_;
    rclcpp::Service<stella_sim::srv::LandGroup>::SharedPtr land_group_srvr_;

    AIRSIM_MODE airsim_mode_ = AIRSIM_MODE::DRONE;

    rclcpp::Service<stella_sim::srv::Reset>::SharedPtr reset_srvr_;
    rclcpp::Publisher<stella_sim::msg::GPSYaw>::SharedPtr origin_geo_point_pub_; // home geo coord of drones
    msr::airlib::GeoPoint origin_geo_point_; // gps coord of unreal origin
    stella_sim::msg::GPSYaw origin_geo_point_msg_; // todo duplicate
    ...
    rclcpp::Subscription<stella_sim::msg::GimbalAngleQuatCmd>::SharedPtr gimbal_angle_quat_cmd_sub_;
    rclcpp::Subscription<stella_sim::msg::GimbalAngleEulerCmd>::SharedPtr gimbal_angle_euler_cmd_sub_;
